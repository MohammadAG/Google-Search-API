...
public class GoogleSearchAPIModule implements IXposedHookLoadPackage, IXposedHookZygoteInit {
	...
	public void handleLoadPackage(LoadPackageParam lpparam) throws Throwable {
		...
		findAndHookMethod(MyVoiceSearchControllerListener, "a", CharSequence.class, findClass("hea", lpparam.classLoader), findClass("bul", lpparam.classLoader), new XC_MethodHook() {
			@Override
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
